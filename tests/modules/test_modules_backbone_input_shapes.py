...
def test_conv_backbone():
    ...
    assert backbone.output_shape == (32, 16, 16)
...
def test_dense_backbone():
    ...
    assert backbone.output_shape == (64,)
...
def test_resnet_backbone():
    ...
    assert backbone.output_shape == (32, 32, 32)


def test_head_flat_dim():
