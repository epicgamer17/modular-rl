...
class TestFPSThroughput(unittest.TestCase):
    """Verifies that executor-level metrics measure total throughput."""
    ...
    def test_multi_actor_sps_scaling(self):
        ...
        self.assertEqual(stats["mcts_sps"], expected_sps)
