...
def test_reward_alignment():
    ...
    # MuZero Target Rewards Expected with current masking:
    # u=0 (root): 0.0
    # u=1 (first unroll): R1 = 10.0
    # u=2 (second unroll): R2 = 20.0
    # u=3 (third unroll): masked out because transition source is terminal.

    expected = [0.0, 10.0, 20.0, 0.0]
