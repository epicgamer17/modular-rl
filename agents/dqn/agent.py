...
from runtime.state import ReplayBuffer, OptimizerState, ModelRegistry, BufferRegistry, OptimizerRegistry
...
class DQNAgent:
    ...
    def compile(self, strict: bool = False):
        ...
        assert isinstance(model_handles, set), f"model_handles must be a set, got {type(model_handles)}"
